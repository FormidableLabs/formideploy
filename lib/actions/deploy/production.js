...
// - [ ] TODO: Name -- need "get 10 most recent". See if S3 can scan backwards?
const createArchive = async () => {
  console.log("TODO: IMPLEMENT createArchive");
  return "TODO_ARCHIVE_PATH";
};
...
const production = async ({ dryrun }) => {
  ...
  const archiveDate = "TODO";
  // DateNum + Hash (?) + Git Dirty (?)
  const archiveName = "archive-TODO";
  const archiveMeta = {
    archiveDate
  };
